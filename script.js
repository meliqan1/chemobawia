...
const phrases = [
 ...
 const video = document.createElement("video");
  ...
  // ვუთითებთ ატრიბუტებს
  video.src = "10.mp4"; // ვიდეოს გზა
  video.controls = true;   // კონტროლების ჩვენება
  video.width = 640;       // სიგანე
  video.height = 360;      // სიმაღლე
  video.autoplay = false;  // ავტომატური გაშვება
